...
```{r}
total_incidents <- 5435 + 1430 + 6429 + 4488 + 2529 + 3463 + 3462 + 3497 + 2465 + 3569 + 2500 + 3509
average_incidents <- 42776 / 12
pg_crime_averages <- 3564.67

pg_crime_averages <- pg_crime |> mutate(total_incidents = sum(42776) |> mutate (average_incidents = total_incidents / 12)
```
