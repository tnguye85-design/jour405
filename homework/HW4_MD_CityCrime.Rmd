...
The cities with the highest violent crime percentage changes were Edmonston (895.32%), Poolesville (607.15%) and Pocomoke City (300.98%). For property crime percent changes, the cities that saw the lowest all had -100.00%: Cecilton, Friendship Heights, Myersville, New Windsor, North Chevy Chase, Pittsville, Port Deposit, Queenstown, Ridgely, Rock Hall, Rosemont and Sharpsburg. However, I would call these cities outliers because their percentage changes could be influenced by their 2020 property rates, which 0. 
