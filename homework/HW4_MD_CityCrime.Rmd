...
The cities with the highest property crime rates are (in order) Ocean City (103.67), Oakland (73.28) and Elkton (68.11) in 2019. For 2020 property crime rates, the cities with the highest rates remain the same. However, the rates changed-- Ocean City rose to 103.96, Oakland rose to 73.64 and Elkton decreased to 68.04.
